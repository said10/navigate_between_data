...
*/ 
export default function (window, document ,Element, NodeList) {
    /**
    ...
    Element.prototype.index = function(selector, parent_element) {
        if (typeof parent_element === "undefined") {
            ...
            var parent = dom.get(parent_element);
        }
    ...
    Element.prototype.fadeToggle = function(duration, callback) {
        duration = duration || 0.5;
        var css_element = window.getComputedStyle(this, null);
        var opacity = css_element["opacity"];
